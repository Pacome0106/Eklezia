...
class _EditUserScreenState extends State<EditUserScreen> {
  ...
  Future update() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('users').doc(widget.uid).set({
        ...
        'sexe': valueChoose2,
        'church': valueParoisse,
        'cevb': valueChoose,
        'role': valueChoose3,
        'groupe': groupeChoose,
        'charisme': charismesChoose,
      });
      Navigator.pushNamedAndRemoveUntil(context, '/', (route) => false);
      notification(context, 'Enregistrement reussi !!', 50);
    } catch (e) {
  ...
  void initState() {
    ...
    valueChoose2 = widget.sexe;
    valueParoisse = widget.paroisse;
    valueChoose = widget.cevb;
    valueChoose3 = widget.role;
    getparoisse();
            ...
            child: CustomScrollView(
              slivers: [
                SliverPersistentHeader(
                  pinned: true,
                  delegate: ScrollAnimation('Modifier votre profile', 'edit',
                                    ...
                                    builder: (context) {
                                      return AlertDialog(
                                        ...
                                        title: Center(
                                          child: AppText(
                                            text:
                                                'Souhaitez-vous modifier votre profile ?',
                                            size: 16,
                                            color:
                ...
                SliverList(
                  delegate:
                      SliverChildBuilderDelegate(childCount: groupes.length,
